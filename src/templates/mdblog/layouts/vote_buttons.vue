<template>
  ...
  >
    <button class="mdui-fab mdui-ripple mdui-color-theme-accent">
      ...
      <i
        id="mdblog-scroll"
        class="mdui-icon mdui-fab-opened material-icons"
      >
        keyboard_arrow_up
      </i>
    </button>
    <div class="mdui-fab-dial">
      <button
        v-if="uid"
        class="mdblog-fab-icon mdui-fab mdui-fab-mini mdui-ripple mdui-color-red"
        :hidden="vote == 0"
      ...
      <button
        v-if="uid"
        class="mdblog-fab-icon mdui-fab mdui-fab-mini mdui-ripple mdui-color-teal"
      ...
      <a
        class="mdblog-fab-icon mdui-fab mdui-fab-mini mdui-ripple mdui-color-orange"
        href="#blog-comments"
      >
        <i class="mdui-icon material-icons">
          chat
      ...
      <a
        v-if="BlogGlobals.isAuthor"
        class="mdblog-fab-icon mdui-fab mdui-fab-mini mdui-ripple mdui-color-blue"
        :href="BlogGlobals.luoguAddress+'/blogAdmin/article/edit/' + BlogGlobals.blogID"
      >
        <i class="mdui-icon material-icons">
          edit
        </i>
