...
<div class="mdui-valign" style="margin: 30px;" v-if="ready">
    <div class="mdui-center">
        <div class="mdui-btn-group" v-if="totalPages > 1">
            ...
            <a @click="callback(page - 1)" :class="{ disabled: page == 1 }" class="mdui-btn"><i class="mdui-icon material-icons">keyboard_arrow_left</i></a>
            ...
            <a @click="callback(page + 1)" :class="{ disabled: page == totalPages }" class="mdui-btn"><i class="mdui-icon material-icons">keyboard_arrow_right</i></a>
            <a @click="callback(totalPages)" :class="{ disabled: page == totalPages }"  class="mdui-btn"><i class="mdui-icon material-icons">last_page</i></a>
        </div>
    </div>
</div>
</template>
